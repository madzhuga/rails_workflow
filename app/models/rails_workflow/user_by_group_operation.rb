module RailsWorkflow
  #
  # RailsWorkflow::UserByGroupOperation is user operation which uses user groups
  # for assignment
  # Here you can see it's template example:
  ...
  class UserByGroupOperation < Operation
    ...
    # User operation can't start so it switched to WAITING status so that user can pick up
